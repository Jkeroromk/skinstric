...
const Testing = () => {
  ...
  return (
    <ToastProvider>
      <Headers />
      <div className="min-h-screen flex flex-col items-center justify-center bg-white text-center relative pt-[64px]">
        {/* Top Left Text */}
        ...
        {/* Back Button */}
        <div className="absolute bottom-28 left-8 flex items-center gap-1 scale-[0.85]">
        ...
        {/* Process Button */}
        {submitted && (
          <div className="absolute bottom-28 right-8 flex items-center gap-1 scale-[0.85]">
            <div className="relative w-14 h-14 flex items-center justify-center border border-black rotate-45">
              <span className="absolute rotate-[-45deg] text-xs font-semibold">
                PROCESS
              </span>
